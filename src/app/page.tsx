  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="relative min-h-screen flex items-center justify-center px-6 pb-24">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-[var(--color-forest-900)]/70 via-[var(--color-forest-900)]/50 to-[var(--color-forest-900)]/80" />
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10 pt-16">
          ...
          <p className="text-lg sm:text-xl text-white/90 mb-8 leading-relaxed max-w-2xl mx-auto drop-shadow-sm">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="inline-flex items-center justify-center gap-3 px-8 py-3.5 bg-[#25D366] text-white rounded-lg font-medium hover:bg-[#1ebe57] transition-colors shadow-lg"
            >
      ...
      >
        <Image
          ...
          aria-hidden="true"
        />
        <div className="absolute inset-0 bg-[var(--color-forest-900)]/75" />
